...
df <- read_excel('/Users/danagoin/Box Sync/Fluoride and pregnant women/PRHE-fluoride-pregnancy/data/Data.xlsx')
...
eth <- read.csv("/Users/danagoin/Box Sync/Fluoride and pregnant women/PRHE-fluoride-pregnancy/data/ethnicity.csv")
bio <- read.csv("/Users/danagoin/Box Sync/Fluoride and pregnant women/PRHE-fluoride-pregnancy/data/biospecimen_log.csv")
...
df_meiosis_chart <- read.csv('/Users/danagoin/Box Sync/Fluoride and pregnant women/PRHE-fluoride-pregnancy/data/Meiosis_Chart/meiosis_chart.csv')
...
df_meiosis_bpa <- read.csv('/Users/danagoin/Box Sync/Fluoride and pregnant women/PRHE-fluoride-pregnancy/data/Meiosis_BPA/meiosis_bpa.csv')
...
ggsave(p_grid, file="/Users/danagoin/Box Sync/Fluoride and pregnant women/PRHE-fluoride-pregnancy/water_fluoride_scatter_grid.pdf", width=18)
...
ggsave(rp1, file="/Users/danagoin/Box Sync/Fluoride and pregnant women/PRHE-fluoride-pregnancy/muf_msf_ratio_plot.pdf", width=8)
...
ggsave(rp2, file="/Users/danagoin/Box Sync/Fluoride and pregnant women/PRHE-fluoride-pregnancy/muf_msf_ratio_boxplot.pdf", width=8)
...
write.csv(cor_mat, file="/Users/danagoin/Box Sync/Fluoride and pregnant women/PRHE-fluoride-pregnancy/correlation_matrix.csv")
...
ggsave(p1, file="/Users/danagoin/Box Sync/Fluoride and pregnant women/PRHE-fluoride-pregnancy/water_urine_fluoride_ppm.pdf", width=8)

ggsave(p2, file="/Users/danagoin/Box Sync/Fluoride and pregnant women/PRHE-fluoride-pregnancy/serum_amniotic_fluoride_ppm.pdf", width=8)
...
df_ad <- read_xlsx("/Users/danagoin/Box Sync/Fluoride and pregnant women/data/50 Matched Pairs Am.Fl. and M. Urine D2  Fluoride study 2018.07.23.xlsx", sheet="Full Address", range="A2:D52")
...
write.csv(df_ad, file="/Users/danagoin/Box Sync/Fluoride and pregnant women/data/WOC_address.csv", row.names = F)
...
water_shp <- st_read("//Users/danagoin/Box Sync/Fluoride and pregnant women/data/Water_Districts/Water_Districts.shp")
...
fluoride_levels <- read_xlsx("/Users/danagoin/Box Sync/Fluoride and pregnant women/data/data2014_15.xlsx")
...
point <- read.csv("//Users/danagoin/Box Sync/Fluoride and pregnant women/data/WOC_address_geocoded.csv")
...
ca_shp <- st_read("/Users/danagoin/Box Sync/Fluoride and pregnant women/data/tl_2014_us_state/tl_2014_us_state.shp")
ca_shp <- ca_shp %>% filter(STATEFP=="06")

# read in county shapefile 
county <- st_read("/Users/danagoin/Box Sync/Fluoride and pregnant women/PRHE-fluoride-pregnancy/tl_2016_us_county/tl_2016_us_county.shp")
...
ggsave(m1, file="/Users/danagoin/Box Sync/Fluoride and pregnant women/PRHE-fluoride-pregnancy/water_fluoride_ppt_wd_map.pdf")
...
ggsave(m2, file="/Users/danagoin/Box Sync/Fluoride and pregnant women/PRHE-fluoride-pregnancy/water_fluoride_ppt_cty_map.pdf")
...
cw_z <- read_excel("/Users/danagoin/Box Sync/Fluoride and pregnant women/PRHE-fluoride-pregnancy/zip_to_zcta_2018.xlsx")
...
cw <- read.csv("/Users/danagoin/Box Sync/Fluoride and pregnant women/PRHE-fluoride-pregnancy/geocorr2014_zip_place.csv")
...
cw <- read.csv("/Users/danagoin/Box Sync/Fluoride and pregnant women/PRHE-fluoride-pregnancy/geocorr2014_zip_county.csv")
...
zip <- st_read("/Users/danagoin/Box Sync/Fluoride and pregnant women/PRHE-fluoride-pregnancy/tl_2016_us_zcta510/tl_2016_us_zcta510.shp")
...
ggsave(map1, file="/Users/danagoin/Box Sync/Fluoride and pregnant women/PRHE-fluoride-pregnancy/zip_water_fluoride_map.pdf")
